...
| [`@superbiche/openrouter-paperclip-adapter`](./packages/openrouter-local) | [OpenRouter API](https://openrouter.ai) | [![npm](https://img.shields.io/npm/v/@superbiche/openrouter-paperclip-adapter.svg)](https://www.npmjs.com/package/@superbiche/openrouter-paperclip-adapter) |
